            ...
            <div class="p-6 space-y-6">
                <div class="flex flex-col sm:flex-row sm:items-center sm:justify-between gap-4">
                    <div class="relative max-w-sm w-full">
                        ...
                        <input type="text" placeholder="Search invoices..." class="w-full pl-10 pr-4 py-2 rounded-lg border border-slate-200 focus:outline-none focus:ring-2 focus:ring-primary">
                    </div>
                ...
                <div class="card">
                    ...
                    <div class="overflow-x-auto">
                        <table class="min-w-full">
                            ...
                            <tbody>
                                ...
                                ['INV-006', 'Cloud Nine', '$4,200.00', 'Oct 12, 2023', 'Pending', 'amber'],
                                ['INV-007', 'Pixel Perfect', '$950.00', 'Oct 10, 2023', 'Paid', 'emerald']
                                ] as $invoice)
                                <tr class="border-b border-slate-200 hover:bg-slate-50 transition-colors">
                                    ...
                                    @if($invoice[4] === 'Paid') bg-emerald-50 text-emerald-700
                    ...
                    <div class="mt-6 flex items-center justify-between text-sm text-slate-600">
                        ...
                        <div class="flex gap-2">
                            <button class="px-3 py-1 border border-slate-200 rounded-lg hover:bg-slate-50 transition-colors">Previous</button>
                            <button class="px-3 py-1 border border-slate-200 rounded-lg hover:bg-slate-50 transition-colors">Next</button>
                        </div>
                    </div>
                </div>
            </div>
