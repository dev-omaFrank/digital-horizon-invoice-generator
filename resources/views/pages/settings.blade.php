                        ...
                        <div @class(['space-y-6'])>
                            <div @class(['flex', 'items-center', 'gap-6'])>
                                ...
                                <div>
                                    ...
                                    <div @class(['mt-3', 'flex', 'gap-2'])>
                                        ...
                                        <button type="button" @class(['text-xs', 'px-3', 'py-1', 'text-red-600', 'hover:bg-red-50', 'transition-colors', 'font-medium']) id="removeBtn">Remove</button>
                                    </div>
                                </div>
                            </div>
                            ...
                            <div @class(['grid', 'grid-cols-1', 'md:grid-cols-2', 'gap-6'])>
                                ...
                                <div>
                                    ...
                                    <input type="email" name="businessEmail" value="{{ old('businessEmail') }}" placeholder="alex@example.com" @class(['w-full', 'px-2', 'py-2', 'rounded-lg', 'border', 'border-slate-200', 'focus:outline-none', 'focus:ring-2', 'focus:ring-primary'])>
                                    @error('businessEmail')
                                        <p @class(['mt-1', 'text-sm', 'text-red-600'])>{{ $message }}</p>
                                    @enderror
                                </div>
                                ...
                                <div>
                                    ...
                                    <input type="tel" name="businessPhoneNo" value="{{ old('businessPhoneNo') }}" placeholder="+1 (555) 000-0000" @class(['w-full', 'px-2', 'py-2', 'rounded-lg', 'border', 'border-slate-200', 'focus:outline-none', 'focus:ring-2', 'focus:ring-primary'])>
                    ...
                    <div @class(['card']) style="margin-top: 50px">
                        ...
                        <div @class(['grid', 'grid-cols-1', 'md:grid-cols-2', 'gap-6'])>
                            ...
                            <div @class(['md:col-span-2'])>
                                ...
                                <input type="text" name="bank_name" value="{{ old('bank_name') }}" @class(['w-full', 'px-2', 'py-2', 'rounded-lg', 'border', 'border-slate-200', 'focus:outline-none', 'focus:ring-2', 'focus:ring-primary'])>
                                @error('bank_name')
                                    <p @class(['mt-1', 'text-sm', 'text-red-600'])>{{ $message }}</p>
                                @enderror

                                <label @class(['block', 'text-sm', 'font-medium', 'text-slate-900', 'mb-2'])>Account Name</label>
                                <input type="text" name="account_name" value="{{ old('account_name') }}" @class(['w-full', 'px-2', 'py-2', 'rounded-lg', 'border', 'border-slate-200', 'focus:outline-none', 'focus:ring-2', 'focus:ring-primary'])>
                                @error('account_name')
                                    <p @class(['mt-1', 'text-sm', 'text-red-600'])>{{ $message }}</p>
                                @enderror

                                <label @class(['block', 'text-sm', 'font-medium', 'text-slate-900', 'mb-2'])>Account Number</label>
                                <input type="text" name="account_number" value="{{ old('account_number') }}" @class(['w-full', 'px-2', 'py-2', 'rounded-lg', 'border', 'border-slate-200', 'focus:outline-none', 'focus:ring-2', 'focus:ring-primary'])>
                                @error('account_number')
                                    <p @class(['mt-1', 'text-sm', 'text-red-600'])>{{ $message }}</p>
                                @enderror

                                <label @class(['block', 'text-sm', 'font-medium', 'text-slate-900', 'mb-2'])>Bank Code(Optional)</label>
                                <input type="text" name="bank_code" value="{{ old('bank_code') }}" @class(['w-full', 'px-2', 'py-2', 'rounded-lg', 'border', 'border-slate-200', 'focus:outline-none', 'focus:ring-2', 'focus:ring-primary'])>
                                @error('bank_code')
                                    <p @class(['mt-1', 'text-sm', 'text-red-600'])>{{ $message }}</p>
                                @enderror
