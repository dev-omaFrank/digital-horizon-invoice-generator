                ...
                <div class="card">
                    ...
                    <div class="space-y-6">
                        <div class="flex items-center gap-6">
                            ...
                            <div>
                                <h4 class="text-sm font-semibold text-slate-900">Business Logo</h4>
                                <p class="text-xs text-slate-600 mt-1">PNG, JPG up to 2MB. Recommended size 400x400px.</p>
                                <div class="mt-3 flex gap-2">
                                    <input type="file" accept="image/*" id="fileInput" class="text-xs px-3 py-1 border border-slate-200 rounded-lg hover:bg-slate-50 transition-colors font-medium">
                        ...
                        <div class="grid grid-cols-1 md:grid-cols-2 gap-6">
                            <div class="md:col-span-2">
                                ...
                                <input type="text" value="Digital Horizon" class="w-full px-4 py-2 rounded-lg border border-slate-200 focus:outline-none focus:ring-2 focus:ring-primary">
                            </div>
                            <div>
                                <label class="block text-sm font-medium text-slate-900 mb-2">Email Address</label>
                                <input type="email" value="alex@example.com" class="w-full px-4 py-2 rounded-lg border border-slate-200 focus:outline-none focus:ring-2 focus:ring-primary">
                            </div>
                            <div>
                                <label class="block text-sm font-medium text-slate-900 mb-2">Phone Number</label>
                                <input type="tel" value="+1 (555) 000-0000" class="w-full px-4 py-2 rounded-lg border border-slate-200 focus:outline-none focus:ring-2 focus:ring-primary">
                            </div>
                            <div class="md:col-span-2">
                                <label class="block text-sm font-medium text-slate-900 mb-2">Address</label>
                                <textarea class="w-full px-4 py-2 rounded-lg border border-slate-200 focus:outline-none focus:ring-2 focus:ring-primary h-24">123 Creative Lane, Suite 100
                ...
                <div class="card">
                    ...
                    <div class="grid grid-cols-1 md:grid-cols-2 gap-6">
                        <div>
                            ...
                            <select class="w-full px-4 py-2 rounded-lg border border-slate-200 focus:outline-none focus:ring-2 focus:ring-primary">
                                <option>USD ($)</option>
                                <option>EUR (€)</option>
                                <option>GBP (£)</option>
                            </select>
                        ...
                        <div>
                            ...
                            <input type="number" value="10" class="w-full px-4 py-2 rounded-lg border border-slate-200 focus:outline-none focus:ring-2 focus:ring-primary">
                        </div>
                        <div class="md:col-span-2">
                            <label class="block text-sm font-medium text-slate-900 mb-2">Bank Information (Displayed on Invoice)</label>
                            <textarea placeholder="Bank Name, Account Number, SWIFT/BIC..." class="w-full px-4 py-2 rounded-lg border border-slate-200 focus:outline-none focus:ring-2 focus:ring-primary h-24"></textarea>
                        </div>
                    </div>
